      ...
      echo'<script>          
        ...
        echo '<!-- Datos del lote -->
            ...
            <div class="form-group col-sm-3">
              ...
              <div class="input-group">              
                <span class="input-group-addon">%</span> 
                <input type="text" class="form-control" id="cot_tci" name="cot_tci" value="0" placeholder="Total de Cuota Inicial" required>
              </div>
            </div>
            <div class="form-group col-sm-3">
              <div class="input-group">              
                <span class="input-group-addon">US$</span> 
                <input type="text" class="form-control" id="cot_sep_usd" name="cot_sep_usd" placeholder="0.00" required>
              </div>
            </div>
            <div class="form-group col-sm-3">
              <div class="input-group">              
                <span class="input-group-addon">US$</span> 
                <input type="text" class="form-control" id="cot_cis_usd" name="cot_cis_usd" placeholder="0.00" required>
              </div>
            </div>
            <div class="form-group col-sm-3">
              <div class="input-group">              
                <span class="input-group-addon">US$</span> 
                <input type="text" class="form-control" id="cot_sci_usd" name="cot_sci_usd" readonly placeholder="0.00" required>
              </div>
            </div>
            <div class="form-group col-sm-3">
              <div class="input-group">              
                <span class="input-group-addon">US$</span> 
                <input type="text" class="form-control" id="cot_tci_usd" name="cot_tci_usd" readonly placeholder="Total de Cuota Inicial" required>
              </div>
            </div>
            <div class="form-group col-sm-12">
            ...
            <div class="form-group col-sm-3">
              <div class="input-group">              
                ...
                <input type="text" class="form-control" id="cot_mfd" name="cot_mfd" readonly placeholder="Monto Financiamiento Directo" required>
              </div>
            </div>
            <div class="form-group col-sm-3">
              <div class="input-group">              
                <span class="input-group-addon">PFD</span> 
                <input type="text" class="form-control" id="cot_pfd" name="cot_pfd" placeholder="Plazo Financiamiento Directo" required>
              </div>
            </div>
            <div class="form-group col-sm-3">
              <div class="input-group">              
                <span class="input-group-addon">Cuotas</span> 
                <input type="text" class="form-control" id="cot_cuota" name="cot_cuota" readonly placeholder="Cuotas" required>
              </div>
            </div>
            <div class="form-group col-sm-3">
              <div class="input-group">              
                <span class="input-group-addon">Cuot M(Aprox)</span> 
                <input type="text" class="form-control" id="cot_cuotam" name="cot_cuotam" readonly placeholder="Cuota Mensual" required>
              </div>
            </div>';
