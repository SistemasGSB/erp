        ...
        echo '<!-- Datos del lote -->
            ...
            <div class="form-group col-sm-4">
              ...
              <div class="input-group">              
                ...
                <input type="text" class="form-control" id="fecha_deposito" name="fecha_deposito" required>
              </div>
            </div>
            <div class="form-group col-sm-4">
              ...
              <div class="input-group">              
                ...
                <input type="text" class="form-control" id="res_operacion" name="res_operacion" value="0" placeholder="N° Operacion" required>
              </div>
            </div>';
