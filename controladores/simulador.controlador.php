        ...
        echo '<!-- Datos del lote -->
            ...
            <div class="form-group col-sm-6">
              <div class="input-group">              
                ...
                <input type="text" class="form-control" id="sim_periocidad" name="sim_periocidad" placeholder="Periocidad" required>
              </div>
            </div>
            <div class="form-group col-sm-6">
              <div class="input-group">              
                <span class="input-group-addon">PERIODO DE GRACIA</span> 
                <input type="text" class="form-control" id="sim_per_gracia" name="sim_per_gracia" value="0" required>
              </div>
            </div>
            <div class="form-group col-sm-6">
              <div class="input-group">              
                <span class="input-group-addon">TCEA (%)</span> 
                <input type="text" class="form-control" id="sim_cot_tcea" name="sim_cot_tcea" placeholder="TCEA" required>
              </div>
            </div>
            <div class="form-group col-sm-6">
              <div class="input-group">              
