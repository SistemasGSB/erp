...
class facturas{
	...
	//**
	$html = <<<EOF
	<table style="border: 1px solid #ffffff; text-align:right; line-height: 5px; font-size:8px">
		<tr>
			<td width="540px" style="border: 1px solid #ffffff; background-color:white;">N° 0000$valor_principal</td>			
		</tr>
	</table>
	<table style="border: 1px solid #ffffff; text-align:center; line-height: 20px; font-size:12px">
		<tr>
			<td width="540px" style="border: 1px solid #ffffff; background-color:white;">RESERVA TEMPORAL DE LOTE</td>			
		</tr>
	</table>
	<table style="border: 1px solid #ffffff; text-align:right; line-height: 10px; font-size:8px">
		<tr>
			<td width="540px" style="border: 1px solid #ffffff; background-color:white;">FECHA DE RESERVA: $fecha_deposito</td>		
		</tr>
		<tr>
			<td width="540px" style="border: 1px solid #ffffff; background-color:white;color:white">BLANCO</td>			
		</tr>
		<tr>
			<td width="540px" style="border: 1px solid #ffffff; background-color:white;">VENCIMIENTO DE RESERVA: $nuevafecha</td>			
		</tr>
		<tr>
			<td width="540px" style="border: 1px solid #ffffff; background-color:white;color:white">BLANCO</td>			
		</tr>
	...
	<table style="border: 1px solid #ffffff; line-height: 10px; font-size:8px">
		...
		<tr>
			<td width="300px" style="border: 1px solid #000000; background-color:white;">•2</td>
			<td width="100px" style="border: 1px solid #000000; background-color:white;">D.N.I.</td>	
			<td width="140px" style="border: 1px solid #000000; background-color:white;">  </td>				
		</tr>
		<tr>
		...
		<tr>
			<td width="540px" style="border: 1px solid #ffffff; background-color:white;">EL INTERESADO manifiesta su interés en comprar el lote (en adelante EL LOTE) de propiedad de ALMA PERU E.I.R.L  (en adelante LA EMPRESA) que se detalla a continuación:</td>			
		</tr>
	</table>
	<table style="border: 1px solid #ffffff; text-align:center; line-height: 10px; font-size:8px">
		...
		<tr>
			...
			<td width="180px" style="border: 1px solid #000000; background-color:#D9D9D9;">Provincia</td>	
			<td width="180px" style="border: 1px solid #000000; background-color:#D9D9D9;">Departamento</td>				
		</tr>
		<tr>
	...
	<table style="border: 1px solid #ffffff; text-align:center; line-height: 10px; font-size:8px">
		...
		<tr>
			...
			<td width="100px" style="border: 1px solid #000000; background-color:white;">S/.</td>
			<td width="100px" style="border: 1px solid #000000; background-color:white;">0.00</td>				
		</tr>
		<tr>
...
b)	Si EL INTERESADO no cumple con suscribir EL CONTRATO en el plazo establecido, el importe de la garantía se aplicará automáticamente, sin necesidad de acto o declaración adicional que la contenida en este documento, al pago de la penalidad pactada a cargo de EL INTERESADO.</td>
	...
	<table style="border: 1px solid #ffffff; text-align:center; line-height: 10px; font-size:8px">
		...
		<tr>
			<td width="540px" style="border: 1px solid #000000; background-color:white;">INSTRUCCIONES PARA LA FIRMA DE EL CONTRATO<br>NO OLVIDAR llevar fotocopia y original del D.N.I. y recibo de luz o agua cancelado y Voucher de depósito</td>				
		</tr>
	</table>
